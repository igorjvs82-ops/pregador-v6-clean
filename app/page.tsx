    ...
    <main className="marketing-page">
      <header className="marketing-nav">
        ...
        <nav className="marketing-links">
          ...
          <a href="#radar">Radar teológico</a>
          <a href="#beta">Beta</a>
      ...
      <section className="marketing-hero">
        <div className="hero-copy">
          ...
          <div className="actions"><a className="btn btn-gold" href="#beta">Entrar no beta pastoral</a><a className="btn btn-secondary" href="#exemplo">Ver exemplo de preparação</a></div>
      ...
      <section id="confianca" className="marketing-section split-section">
        <div>
          ...
          <p className="lead">Ferramentas genéricas de IA podem gerar textos rápidos, mas o púlpito exige mais do que velocidade. Exige fidelidade bíblica, contexto, clareza, aplicação pastoral e responsabilidade diante de Deus e da igreja.</p>
          <p>O Verbum foi pensado para apoiar o processo de preparação, não para substituir estudo bíblico, oração ou discernimento pastoral.</p>
        </div>
      ...
      <section className="marketing-section">
        ...
        <div className="feature-grid">
          <div className="feature-card"><b>01</b><h3>Pouco tempo</h3><p>Organizar texto, contexto, estrutura e aplicação pode consumir horas antes mesmo da escrita final.</p></div>
      ...
      <section id="como-funciona" className="marketing-section">
        ...
        <div className="feature-grid">
          <div className="feature-card"><b>01</b><h3>Informe o texto e o contexto</h3><p>Passagem, versão, tema, ocasião, público, duração e objetivo espiritual.</p></div>
      ...
      <section id="beta" className="marketing-section final-cta">
        ...
        <h2>Ajude a construir uma ferramenta séria para pregadores fiéis ao texto.</h2>
        <p>Estamos formando o primeiro grupo de usuários do Verbum. As vagas são limitadas para manter acompanhamento próximo e coletar feedback pastoral real.</p>
        {betaSent ? <p className="badge" style={{ margin: '0 auto 18px' }}>Candidatura recebida. Entraremos em contato.</p> : null}
        <form className="card" action="/api/beta-leads" method="post" style={{ maxWidth: 860, margin: '24px auto 0', textAlign: 'left' }}>
          <div className="form-grid">
            ...
            <div className="field"><label>Frequência de pregação/ensino</label><select name="frequency" required><option>Toda semana</option><option>A cada 15 dias</option><option>Uma vez por mês</option><option>Ocasionalmente</option><option>Ainda estou em formação</option></select></div>
            <div className="field"><label>Maior dificuldade</label><select name="main_challenge" required><option>Exegese</option><option>Estrutura da mensagem</option><option>Aplicação pastoral</option><option>Falta de tempo</option><option>Revisão teológica</option><option>Slides/material de apoio</option><option>Clareza na comunicação</option></select></div>
            <div className="field full"><label>O que você espera de uma ferramenta como o Verbum?</label><textarea name="expectation" rows={4} /></div>
          </div>
